...
4. Select **Suggest Question** next to a skill.
   ...
   .. figure:: /images/contributors/suggest_question_dashboard.png
      :alt: Suggest a question for a skill on the Contributor Dashboard
      :align: center
...
5. Choose the difficulty level. If the skill creator has provided **Rubrics**, they will appear here to explain what makes a question suitable for Easy, Medium, or Hard levels.
   ...
   .. figure:: /images/contributors/question_difficulty_dialog.png
      :alt: Question difficulty selection dialog
      :align: center
...
2. Choose an interaction that fits your question (e.g., Equations, Math Expressions, Multiple Choice).
   ...
   .. figure:: /images/contributors/add_interaction_button.png
      :alt: Add Interaction button
      :align: center

      *Fig. 3. The +Add Interaction button appears below the question*

   .. figure:: /images/contributors/choose_interaction_dialog.png
      :alt: Choose Interaction dialog
      :align: center
...
2. At least one response **must** be marked as correct.
   ...
   .. figure:: /images/contributors/mark_correct_answer.png
      :alt: Mark correct answer checkbox
      :align: center
...
4. **Solicit Answer Details (Optional):** If you want Oppia to ask the learner to explain their reasoning, check this box in the editing screen.
   ...
   .. figure:: /images/contributors/solicit_answer_details.png
...
.. figure:: /images/contributors/tagging_misconceptions.png
   :alt: Tagging responses with a misconception
   :align: center
...
2. Select **Mark as Not Applicable**.
   ...
   .. figure:: /images/contributors/optional_required_misconceptions.png
      :alt: Optional and required misconceptions UI
      :align: center
...
.. figure:: /images/contributors/my_contribution_tab.png
   :alt: My Contribution tab on dashboard
   :align: center
